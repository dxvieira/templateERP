      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-white/5 pb-8">
        ...
        <div className="flex gap-4">
          <button 
            ...
            className="flex items-center h-14 gap-2 px-8 bg-zinc-900 text-white font-black text-[10px] uppercase rounded-2xl hover:bg-zinc-800 transition-all border border-zinc-800 hover:border-zinc-700 active:scale-95"
          >
          ...
          {activeTab === 'compras' && itemsPendentes.length > 0 && (
            <button 
              ...
              className="flex items-center h-14 gap-2 px-8 bg-primary text-black font-black text-[10px] uppercase rounded-2xl shadow-[0_0_25px_rgba(255,95,31,0.4)] hover:bg-white transition-all hover:scale-105 active:scale-95 disabled:opacity-50"
            >
