  ...
  return (
    <div className="p-4 md:p-8 space-y-8 mt-14 md:mt-0">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-white/5 pb-8">
        ...
        <button onClick={() => openModal()} className="group flex items-center h-14 gap-4 px-8 rounded-2xl bg-primary text-black font-black uppercase tracking-widest text-[10px] hover:bg-white transition-all shadow-[0_0_25px_rgba(255,95,31,0.4)] hover:scale-105 active:scale-95"><Plus size={18} /> Novo Cadastro</button>
      </header>
